...
const translations: Record<Language, Record<string, string>> = {
  id: {
    ...
    'common.noDescription': 'Tanpa keterangan',
    'common.fromAccount': 'Dari Akun',
    'common.closeModal': 'Tutup modal',
    'budget.repeatMonthly': 'Ulangi Setiap Bulan',
    'budget.repeatMonthlyDesc': 'Otomatis berlaku di bulan berikutnya',
    'budget.selectCategory': 'Pilih kategori',
    'budget.validationCategory': 'Pilih kategori terlebih dahulu',
    'budget.validationAmount': 'Masukkan jumlah yang valid lebih dari 0',
    'budget.validationMonth': 'Pilih bulan yang valid',
    'budget.saveFailed': 'Gagal menyimpan anggaran. Silakan coba lagi.',
    'budget.deleteFailed': 'Gagal menghapus anggaran. Silakan coba lagi.',
    'scan.cameraError': 'Tidak dapat mengakses kamera. Pastikan izin kamera diberikan.',
    'scan.selectMethod': 'Pilih metode scan di bawah',
    'scan.pleaseWait': 'Mohon Tunggu',
    'scan.positionReceipt': 'Posisikan struk di dalam bingkai',
    'scan.uploadPhoto': 'Upload Foto',
    ...
    'auth.forgotDesc': 'Masukkan alamat email Anda untuk menerima tautan reset kata sandi.',
    'auth.emailSent': 'Email Terkirim!',
    'auth.emailSentDesc': 'Periksa kotak masuk Anda untuk instruksi menyetel ulang kata sandi.',
    'auth.backToLogin': 'Kembali ke Masuk',
    'scan.saveTransaction': 'Simpan Transaksi',
    'scan.chooseMethod': 'Pilih cara yang paling nyaman untuk mencatat keuangan Anda hari ini.',
    'scan.rescan': 'Scan Ulang',
    'txn.addTransaction': 'Tambah Transaksi',
    'txn.manualInput': 'Input Manual',
    'txn.manualInputDesc': 'Ketik nominal dan kategori sendiri',
    'txn.scanReceipt': 'Scan Struk',
    'txn.scanReceiptDesc': 'Ambil foto struk, biar AI yang catat',
  ...
  en: {
    ...
    'budget.repeatMonthly': 'Repeat Monthly',
    'budget.repeatMonthlyDesc': 'Automatically applies to next month',
    'budget.selectCategory': 'Select a category',
    'budget.validationCategory': 'Please select a category',
    'budget.validationAmount': 'Please enter a valid amount greater than 0',
    'budget.validationMonth': 'Please select a valid month',
    'budget.saveFailed': 'Failed to save budget. Please try again.',
    'budget.deleteFailed': 'Failed to delete budget. Please try again.',
    'scan.cameraError': 'Unable to access camera. Please grant camera permission.',
    'scan.selectMethod': 'Select scan method below',
    'scan.pleaseWait': 'Please Wait',
    'scan.positionReceipt': 'Position receipt in the frame',
    ...
    'auth.forgotDesc': 'Enter your email address to receive a password reset link.',
    'auth.emailSent': 'Email Sent!',
    'auth.emailSentDesc': 'Check your inbox for instructions to reset your password.',
    'auth.backToLogin': 'Back to Login',
    'scan.saveTransaction': 'Save Transaction',
    'scan.chooseMethod': 'Choose the most convenient way to record your finances today.',
    'scan.rescan': 'Rescan',
    'txn.addTransaction': 'Add Transaction',
    'txn.manualInput': 'Manual Input',
    'txn.manualInputDesc': 'Type amount and category yourself',
    'txn.scanReceipt': 'Scan Receipt',
    'txn.scanReceiptDesc': 'Take a photo of receipt, let AI do the rest',
