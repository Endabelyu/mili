    ...
    <div className="space-y-8 animate-fade-in pb-10">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-[24px] font-bold text-[var(--text)] tracking-[-0.02em]">Notifikasi</h1>
            <p className="text-[14px] font-medium text-[var(--text-dim)]">{unreadCount} belum dibaca</p>
          </div>
        </div>
        <button 
      ...
      <section className="space-y-4">
        <h3 className="text-[14px] font-bold text-[var(--text)] ml-1">Baru</h3>
      ...
      <section className="space-y-4">
        <h3 className="text-[14px] font-bold text-[var(--text)] ml-1">Sebelumnya</h3>
        <div className="flow-card divide-y divide-[var(--border)] overflow-hidden">
